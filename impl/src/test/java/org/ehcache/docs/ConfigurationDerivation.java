...
public class ConfigurationDerivation {
  ...
  public void withServiceCreation() {
   ...
   assertThat(configuration.getServiceCreationConfigurations(), IsNot.not(IsIterableContaining.hasItem(IsInstanceOf.instanceOf(PooledExecutionServiceConfiguration.class))));
  ...
  public void withService() {
   ...
   assertThat(configuration.getServiceCreationConfigurations(), IsNot.not(IsIterableContaining.hasItem(
