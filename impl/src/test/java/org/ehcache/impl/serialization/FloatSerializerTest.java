...
public class FloatSerializerTest {
  ...
  @RepeatedTest(100)
  public void testCanSerializeAndDeserialize(@Random float value) {
    FloatSerializer serializer = new FloatSerializer();
    float read = serializer.read(serializer.serialize(value));
    assertThat(read, is(value));
  }

  @Test
  public void testReadThrowsOnNullInput() {
    assertThrows(NullPointerException.class, () -> new FloatSerializer().read(null));
  }

  @Test
  public void testSerializeThrowsOnNullInput() {
    assertThrows(NullPointerException.class, () -> new FloatSerializer().serialize(null));
  }
}
