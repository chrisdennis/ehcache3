...
public class WriteBehindProviderFactoryTest {
  ...
  public void testAddingWriteBehindConfigurationAtCacheLevel() {
    ...
    assertThat(serviceConfiguration, IsIterableContaining.<ServiceConfiguration<?, ?>>hasItem(instanceOf(WriteBehindConfiguration.class)));
    cacheManager.close();
  }
  ...
  public void testWriteBehindWithoutCacheLoaderWriter() {
    ...
    NullPointerException failure = assertThrows(NullPointerException.class, () -> factory.create(null).createWriteBehindLoaderWriter(null, null));
    assertThat(failure.getMessage(), is("WriteBehind requires a non null CacheLoaderWriter."));
  }
