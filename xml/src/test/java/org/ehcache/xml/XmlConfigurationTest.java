...
public class XmlConfigurationTest {
  ...
  public void testInvalidCoreConfiguration() throws Exception {
    try {
      ...
      assertThat(e.getCause().getMessage(), either(containsString("'ehcache:cach'")).or(containsString("<Q{.../v3}cach>")));
    }
  }
  ...
  public void testInvalidServiceConfiguration() throws Exception {
    try {
      ...
      assertThat(e.getCause().getMessage(), either(containsString("'foo:bar'")).or(containsString("<Q{.../foo}bar>")));
    }
  }
